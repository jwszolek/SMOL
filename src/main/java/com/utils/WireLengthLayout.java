...
public class WireLengthLayout<V, E> extends AbstractLayout<V, E> implements
		IterativeContext {
	 ...
	 * @param g
	 */
	public WireLengthLayout(Graph<V, E> g) {
		super(g);
	}
	...
	//wywolywane podczas tworzenia obiektu VisualizationViewer
	...
	private synchronized void adjust() {
		...
		tempXYD.setLocation(10 + Math.random() * getSize().getWidth(), 10
				+ Math.random() * getSize().getHeight());
